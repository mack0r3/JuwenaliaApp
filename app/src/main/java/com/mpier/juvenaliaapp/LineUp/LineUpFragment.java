...
public class LineUpFragment extends Fragment {
    ...
    private HashMap<String, ArrayList<Event>> createEvents() {
        ...
        final ArrayList<Event> saturdayEvents = new ArrayList<Event>() {{
            add(new Event("22:30", "T.Love", "Polski zespół muzyczny, początkowo pozostający pod wpływem rocka, a z ubiegiem czasu rozszerzony o stylistykę reggae, glam rocka, pop rocka czy rock and rolla. Ich albumy zyskały w wiekszości status złotych płyt, jeden z nich zdobył w 2012 platynę. W swojej karierze występowali w prawie całej Europie, a także wielokrotnie w USA", R.drawable.lineup_tlove));
